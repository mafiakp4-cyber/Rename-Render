...
async def start(client, message):
    ...
    button=InlineKeyboardMarkup([[
        InlineKeyboardButton(" Developer ", url='https://t.me/+Tbkw7GQzcB05M2U9')
        ],[
        ...
        InlineKeyboardButton("❤️ subscriber tg ❤️", url='https://t.me/+Tbkw7GQzcB05M2U9')
        ]
        ])
    if START_PIC:
...
async def cb_handler(client, query: CallbackQuery):
    ...
    if data == "start":
        ...
        InlineKeyboardButton("❤️ Subscribe tg ❤️", url='https://t.me/+Tbkw7GQzcB05M2U9')
        ]
        ]
                )
            )
